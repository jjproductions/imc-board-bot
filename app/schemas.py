...
class DoclingBlock(BaseModel):
    id: str
    type: Literal["heading", "paragraph", "list_item", "table", "figure", "caption", "footnote", "page_break"] = "paragraph"
...
class DoclingDocument(BaseModel):
    source_id: str = Field(..., description="Unique ID of the document (e.g., path or SHA).")
